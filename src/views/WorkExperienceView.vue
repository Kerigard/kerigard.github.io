...
const items = ref<Work[]>([
  {
    ...
    experience: [
      ...
      'Разработка и поддержка full stack проектов на Laravel.',
      'Работа с базами данных: MySQL, PostgreSQL, ClickHouse, ElasticSearch.',
      'Развертывание и администрирование серверов в AWS и Yandex Cloud.',
      'Проектирование высоконагруженных систем.',
      'Реализация очередей и асинхронной обработки данных с использованием RabbitMQ.',
